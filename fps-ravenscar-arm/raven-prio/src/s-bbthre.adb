...
package body System.BB.Threads is
   ...
   begin
      ...
      --  Id.Active_Absolute_Deadline :=
      --   (System.BB.Time.Clock + System.BB.Time.Milliseconds (1000000000));
      --  Absolute_Deadline'Last;

      Id.Active_Absolute_Deadline := Relative_Deadline + System.BB.Time.Clock;
   ...
   procedure Initialize_Slave
     (Idle_Thread   : Thread_Id;
      Idle_Relative_Deadline : System.BB.Deadlines.Relative_Deadline;
