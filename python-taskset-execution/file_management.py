...
def make_adb_file (taskset, hyperPeriod):
    ...
    file_adb.write("\n")
    file_adb.write("      procedure Load (Times : Integer);\n")
    file_adb.write("      procedure Load (Times : Integer) is\n")
    ...
    file_adb.write("      Temp2 : Ada.Real_Time.Time_Span;\n")
    file_adb.write("\n")
    file_adb.write("   begin\n")
    file_adb.write("      Temp2 := Next_Period - Ada.Real_Time.Time_First;\n")
    file_adb.write("      Temp2 := (Temp2 / 180000) * 180000;\n")
    file_adb.write("      Temp2 := Temp2 - Ada.Real_Time.Microseconds (73);\n")
    file_adb.write("      Next_Period := Ada.Real_Time.Time_First + Temp2;\n")
    ...
    file_adb.write("         (System.Task_Primitives.Operations.Self,\n")
    file_adb.write("          System.BB.Time.Microseconds (Dead), False);\n")
    ...
    file_adb.write("\n")
    file_adb.write("         Temp := Load_Num;\n")
    file_adb.write("         Load (Temp);\n")
    file_adb.write("\n")
