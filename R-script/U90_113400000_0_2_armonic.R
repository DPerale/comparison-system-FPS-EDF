taskset_0_2 = array (integer(), dim = c(5,1000,13))
...
#
# # short mid long
# res <- boxplot (taskset_0_2[1,,9], taskset_0_2[2,,9], taskset_0_2[3,,9], taskset_0_2[4,,9], taskset_0_2[5,,9], names=c("g1","g2","g3", "g4","g5"), scipen=5, main="tipo task per gruppo", xlab="Task", ylab="quantità")
# abline(h = 7, col = "red")
# res$stats
#
...
taskset_3_6 = array (integer(), dim = c(5,1000,13))
...
taskset_7_20 = array (integer(), dim = c(5,1000,13))
