...
package body Cyclic_Tasks is
   ...
   C1 : Cyclic (10, 16000, 16000, 1, 2704, 0);
   C2 : Cyclic (9, 23000, 23000, 2, 16331, 0);
   C3 : Cyclic (8, 29000, 29000, 3, 6695, 0);
   C4 : Cyclic (7, 31000, 31000, 4, 14255, 0);
   C5 : Cyclic (6, 32000, 32000, 5, 91856, 0);
   C6 : Cyclic (5, 36000, 36000, 6, 100031, 0);
   C7 : Cyclic (4, 39000, 39000, 7, 18395, 0);
   C8 : Cyclic (3, 40000, 40000, 8, 69113, 0);
   C9 : Cyclic (2, 52000, 52000, 9, 1729, 0);
   C10 : Cyclic (1, 100000, 100000, 10, 46719, 0);
end Cyclic_Tasks;