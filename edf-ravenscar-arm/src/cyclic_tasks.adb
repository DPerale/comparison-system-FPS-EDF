...
package body Cyclic_Tasks is
   ...
   C1 : Cyclic (20, 18900, 18900, 1, 4493, 0);
   C2 : Cyclic (19, 30240, 30240, 2, 3180, 0);
   C3 : Cyclic (18, 35000, 35000, 3, 11248, 0);
   C4 : Cyclic (17, 39375, 39375, 4, 7616, 0);
   C5 : Cyclic (16, 40000, 40000, 5, 56661, 0);
   C6 : Cyclic (15, 50400, 50400, 6, 26358, 0);
   C7 : Cyclic (14, 52500, 52500, 7, 3042, 0);
   C8 : Cyclic (13, 54000, 54000, 8, 3233, 0);
   C9 : Cyclic (12, 56700, 56700, 9, 6261, 0);
   C10 : Cyclic (11, 60000, 60000, 10, 3275, 0);
   C11 : Cyclic (10, 60480, 60480, 11, 1878, 0);
   C12 : Cyclic (9, 63000, 63000, 12, 76906, 0);
   C13 : Cyclic (8, 65625, 65625, 13, 51515, 0);
   C14 : Cyclic (7, 75600, 75600, 14, 125929, 0);
   C15 : Cyclic (6, 78750, 78750, 15, 22789, 0);
   C16 : Cyclic (5, 84375, 84375, 16, 90205, 0);
   C17 : Cyclic (4, 87500, 87500, 17, 106722, 0);
   C18 : Cyclic (3, 90000, 90000, 18, 15272, 0);
   C19 : Cyclic (2, 94500, 94500, 19, 14118, 0);
   C20 : Cyclic (1, 100000, 100000, 20, 56280, 0);
end Cyclic_Tasks;